...
COMdisps{1} = [0 0.12 .175-.13];
COMdisps{2} = [0 -.12 .175-.13];
COMdisps{3} = [.2794 0.075 -.13];
COMdisps{4} = [.2794 -0.075 -.13];
COMdisps{5} = [-.2794 0.075 -.13];
COMdisps{6} = [-.2794 -0.075 -.13];
...
for i = 1:6
    ...
    trplot(frame_matrices{i}.T, 'rviz', 'length', .1, 'axes', 'equal')    
    frame_matrices{i}
end
axis equal

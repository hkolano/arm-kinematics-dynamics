...
BaseL = Revolute('a',   46,     'alpha', pi/2,  'd',    107.4,   'offset', pi);
BLink1 = Revolute('a',   293.6,  'alpha', 0,     'd',    0.0,     'offset', -pi/2+th_a);
BLink2 = Revolute('a',   40.8,   'alpha', -pi/2, 'd',    0.0,     'offset', -pi/2-th_a);
BLink3 = Revolute('a',   40.8,   'alpha', -pi/2, 'd',    -160.0,  'offset', 0.0);
BLink4 = Revolute('a',   40.8,   'alpha', -pi/2, 'd',    0.0,     'offset', 0.0);
